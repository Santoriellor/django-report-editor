# Generated by Django 5.0.2 on 2024-03-14 13:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('motor_oil_qty', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('motor_oil_liter_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('gearbox_oil_qty', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('gearbox_oil_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('cleaning_material_qty', models.SmallIntegerField(blank=True, null=True)),
                ('cleaning_material_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('sparkplug_qty', models.SmallIntegerField(blank=True, null=True)),
                ('sparkplug_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('fuelhose_qty', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('fuelhose_meter_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('oring_qty', models.SmallIntegerField(blank=True, null=True)),
                ('oring_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('impeller_qty', models.SmallIntegerField(blank=True, null=True)),
                ('impeller_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('carburetor_seal_qty', models.SmallIntegerField(blank=True, null=True)),
                ('carburetor_seal_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('pins_qty', models.SmallIntegerField(blank=True, null=True)),
                ('pins_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('seals_qty', models.SmallIntegerField(blank=True, null=True)),
                ('seals_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('shear_pin_qty', models.SmallIntegerField(blank=True, null=True)),
                ('shear_pin_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('oilfilter_qty', models.SmallIntegerField(blank=True, null=True)),
                ('oilfilter_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('fuelfilter_qty', models.SmallIntegerField(blank=True, null=True)),
                ('fuelfilter_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('fuel_additive_qty', models.SmallIntegerField(blank=True, null=True)),
                ('fuel_additive_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('descaling_agent_qty', models.SmallIntegerField(blank=True, null=True)),
                ('descaling_agent_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('thermostat_qty', models.SmallIntegerField(blank=True, null=True)),
                ('thermostat_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('propeller_qty', models.SmallIntegerField(blank=True, null=True)),
                ('propeller_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('battery_qty', models.SmallIntegerField(blank=True, null=True)),
                ('battery_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('VRG_battery_qty', models.SmallIntegerField(blank=True, null=True)),
                ('VRG_battery_unit_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('emission_inspection_document_qty', models.SmallIntegerField(blank=True, null=True)),
                ('emission_inspection_document_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('computer_diagnosis_qty', models.SmallIntegerField(blank=True, null=True)),
                ('computer_diagnosis_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('auto_flat_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('emission_inspection_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('cleaning_flat_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('tansport_flat_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('crane_qty', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('crane_hour_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('boat_winter_storage_square_meter', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('boat_winter_storage_square_meter_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('motor_winter_storage_qty', models.SmallIntegerField(blank=True, null=True)),
                ('motor_winter_storage_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('work_hour_qty', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('work_hour_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('total_work_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('total_material_price', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
